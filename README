...
1. Sign Out Button takes you back to login screen
2. Push vs Modal - Got an error trying to go to the 'Communications' page from push

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='https://github.com/sdaviswalmart/HW2-DropBox-Carousel/blob/master/HW%202%20%20DropBox%20Carousel.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
